...
#  
# Expand wireframe 3d shape made in pygame
# https://stackoverflow.com/questions/68204153/expand-wireframe-3d-shape-made-in-pygame/68204459#68204459
# 
...
while run:
    ...
    window.fill(0)
    bezir(window, b_points, 10, (128, 0, 0), 10)
